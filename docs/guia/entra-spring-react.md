...
- Backend: <https://github.com/pauloberrios44/backend-springboot-jwt.git>
- Front: <https://github.com/pauloberrios44/dfs-s3-login-1.git>
...
<https://docs.google.com/document/d/1GCu7jJi-_xCzwbUTPQzGzqG9ETramHho1bvVawHBW0I/edit?usp=sharing>
...
3. Partir del código del profesor:
   ...
   <https://docs.google.com/document/d/13jhQRcs3-ZLInbuYMxPujhQXx9PykdXE-Oe1XsBHjRI/edit?usp=sharing>
...
3. Código de ejemplo del profesor:
   ...
   <https://docs.google.com/document/d/1JHuMEo99-aJNk1paKJt3iVwkEuYk-Ja1u3LnpSS3yPM/edit?usp=sharing>
...
5. Ese string tiene que ser **idéntico** al ámbito de **Exponer una API**.
...
<https://github.com/pauloberrios44/dfs-s3-login-1>
...
- [ ] Existe el registro SPA (React + MSAL + redirect URI).
- [ ] Existe el registro **`api-cloud-native`**.
- [ ] Application ID URI: `api://<API_CLIENT_ID>`.
- [ ] Ámbito `access_as_user` creado (admin + usuarios).
- [ ] Hay un propietario del registro API.
- [ ] Permiso delegado `access_as_user` en la API **y** en la SPA.
- [ ] Consentimiento de administrador concedido (tilde verde).
